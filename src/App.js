...
import { addOne,applyNumber,changeOperationCalculate,deleteCalculate} from './actions';
      ...
      <div className="container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"+"} onClick = {(e) => dispatch(changeOperationCalculate(e.target.value))} />
              <CalcButton value={"*"} onClick = {(e) => dispatch(changeOperationCalculate(e.target.value))} />
              <CalcButton value={"-"} onClick = {(e) => dispatch(changeOperationCalculate(e.target.value))} />
            </div>

            <div className="row ce_button">
              <CalcButton value={"CE"} onClick={() => dispatch(deleteCalculate())}/>
            </div>
